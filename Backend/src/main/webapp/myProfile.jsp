...
<div class="profile">
    ...
    <div class="profile-btns">
        <a href="myTickets.jsp" class="profile-form-btn profile-cream-btn">My Tickets</a>
        <a href="myReviews.jsp" class="profile-form-btn profile-cream-btn">My Reviews</a>
        <a href="editProfile.jsp" class="profile-form-btn profile-red-btn">Edit Profile</a>
        <a href="deleteConfirmation.jsp" class="profile-form-btn profile-red-btn">Delete Profile</a>
    </div>
</div>
